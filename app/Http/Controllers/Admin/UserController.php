...
//            abort(403);
//        }
        $this->inc_js_lib = array_add($this->inc_js_lib, 'filestyle',
            array('url' => '<script src="' . $this->pub_path . '/js/bootstrap-filestyle.min.js"></script>'));
    ...
    public function create()
    {
        ...
        $this->content = view(config('settings.theme') . '.admin.userCreate')->with(array(
            "inputs" => $this->inputs,
            "polices" => $polices
        ))->render();
