    ...
    <header class="box-typical-header">
        <div class="tbl-row">
            <div class="tbl-cell tbl-cell-title">
                <h3 id="h3-create-obj">{{ (isset($object->id)) ? "Редактирование объекта" : "Создание нового объекта" }}</h3>
            </div>
        </div>
    </header>
    <div class="box-typical-body">
        ...
        <div>
            <section>
                ...
                <input type="hidden" name="obj_deal"
                       value="{{isset($object->deal) ? $object->deal  : (isset($deal) ? $deal : old('obj_deal'))}}">
                ...
                <input type="hidden" name="obj_form_3"
                       value="{{isset($object->category) ? (($object->category == 3) ? $object->type : ""): (isset($type) ? $type : old('obj_form_3'))}}">
                            ...
                            @if(isset($object) & isset($object->phones))
                                @foreach($object->phones as $phone)
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="{{$phone}}" id="client_phone"
                                               class="form-control phone-mask-input" required="" name="client_phone2[]"
                                               type="text" placeholder="(___) ___-____" aria-required="true">
                                    </div>
                                @endforeach
                            @endif
                        </div>
